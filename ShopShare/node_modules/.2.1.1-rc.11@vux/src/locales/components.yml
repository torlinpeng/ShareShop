en:
  ...
  preselect China and Japan: preselect China and Japan
  set max=2: set max=2
  ...
  'Notice: It cannot be extracted by Wechat': 'Notice: It cannot be extracted by Wechat'
  ...
  Fav: Fav
  Delete: Delete
  swipeout content: swipeout content
  JavaScript is the bese language: JavaScript is the bese language
  ...
  I\'m description: I\'m description
  I'm content: I'm content
  I'm description: I'm description
  now enabled: now enabled
  now disaled: now disaled
  ...
  position: position
  only hour and minute: only hour and minute
  Choose: Choose
...
zh-CN:
  ...
  'Are you sure?<br/><span style="color:#666;font-size:12px;">Once deleted, you will never find it.</span>': '确定咩?<br/><span style="color:#666;font-size:12px;">删除后就无法撤消了哦</span>'
  ...
  handle errors: 处理错误
  preselect China and Japan: 默认选中China和Japan
  set max=2: 最多可选中2个
  ...
  'format: YYYY-MM-DD HH:mm': '格式：YYYY-MM-DD HH:mm'
  start time: 开始时间
  Placeholder: 提示文字
  Please select: 请选择
  ...
  'Notice: It cannot be extracted by Wechat': 注意：canvas模式下不能在微信里长按识别
  current url: 当前url
  ...
  Fav: 收藏
  Delete: 删除
  swipeout content: JavaScript 是最好的语言
  JavaScript is the bese language: JavaScript 是最好的语言
  Limit hours: 限定小时范围
  09-18: 工作时间 09-18
